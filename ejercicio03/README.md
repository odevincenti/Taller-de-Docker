...
1. Descargo la primer imagen con:
```
 docker pull nicopaez/passwordapi-java:java8-alpine
```
2. Para ver las layers corro el siguiente comando (siendo 22e1f6ea60af la image id de la imagen descargada):
```
docker inspect 22e1f6ea60af
```
3. En la propiedad "Layers", encontramos 4 layers:
```
"Layers": [
...
```
4. Descargo la segunda imagen con:
```
 docker pull nicopaez/passwordapi-java:java8-fabric
```
5. Para ver las layers corro el siguiente comando (siendo c479d0765f34 la image id de la imagen descargada):
```
docker inspect c479d0765f34
```
6. En la propiedad "Layers", encontramos 9 layers:
```
"Layers": [
                "sha256:73046094a9b835e443af1a9d736fcfc11a994107500e474d0abf399499ed280c",
...
```
7. Notamos que ambas tienen el primer layer en común. 